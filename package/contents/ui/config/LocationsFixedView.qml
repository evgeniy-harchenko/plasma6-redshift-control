...
Kirigami.FormLayout {
    ...
    property double longitudeFixed: 0
    property double latitudeFixed: 0
    ...
    ColumnLayout {
        ...
        Kirigami.ShadowedRectangle {
            ...
            Flickable {
                ...
                Image {
                    ...
                    Kirigami.Icon {
                        z: 9999
                        readonly property double rawX: longitudeToX(longitudeFixed)
                        readonly property double rawY: latitudeToY(latitudeFixed)
                    ...
                    TapHandler {
                        onTapped: event => {
                            ...
                            longitudeFixed = xToLongitude(clickPos.x);
                            latitudeFixed = yToLatitude(clickPos.y);
                        }
                    }
        ...
        RowLayout {
            ...
            NumberField {
                ...
                backend: latitudeFixed
                onBackendChanged: {
                    latitudeFixed = backend;
                }
            }
            ...
            NumberField {
                ...
                backend: longitudeFixed
                onBackendChanged: {
                    longitudeFixed = backend;
                }
            }
        }
    }

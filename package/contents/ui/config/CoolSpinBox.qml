...
QQC2.SpinBox {
    ...
    function bindContentItem() {
        if (contentItem && contentItem instanceof TextInput) {
            ...
            contentItem.leftPadding = Qt.binding(function () {
                return prefixLabel.implicitWidth
            })
            contentItem.rightPadding = Qt.binding(function () {
                return suffixLabel.implicitWidth
            })
